...
public class MethodesController implements ControllerByMain {
    ...
    public void initialize() {
        ...
        btnVisu.setOnAction(e -> {
            ...
            if (img == null) img = DataHolder.getImageOriginale();
    ...
    public void onDebruiter(ActionEvent event) throws IOException {
        ...
        List<Patch> rec = CollectionVecteur.reconstruirePatchsDepuisContributions(
            projFinal, baseMat, mcr.moyenne.valeurs, taillePatch, patchs
        );
