...
public class Main {
   public static void main(String[] args) {
       try {
           ...
           String csvFile = "data/donnees.csv";
           ...
           for (int sigma : sigmas) {
               BufferedImage image_bruitee = ImageUtils.noising(imageOriginale, sigma);
               ImageIO.write(image_bruitee, "jpeg", new File("images_test_bruite/lemurien_bruitee_sigma_" + sigma + ".jpeg"));
               float pourcentage_ressemblance = ImageUtils.comparaison_bruitee_base(imageOriginale, image_bruitee);
