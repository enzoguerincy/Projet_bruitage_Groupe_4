...
public class Seuillage {
	...
	/**
	 * Calcule la variance empirique d'un ensemble de vecteurs. Utilisé pour estimer
	 * la variance du signal bruité.
	 *
	 * @param vecteurs La liste des vecteurs contenant les coefficients.
	 * @return La variance des coefficients de tous les vecteurs.
	 */
	...
	/**
	 * Applique un seuillage dur (Hard Thresholding). Met à zéro les coefficients
	 * dont la valeur absolue est inférieure ou égale au seuil.
	 *
	 * @param lambda Le seuil à appliquer.
	 * @param x      Le tableau de coefficients à seuiller.
	 * @return Un tableau seuillé (hard thresholding).
	 */
	...
	/**
	 * Applique un seuillage doux (Soft Thresholding). Réduit de λ les coefficients
	 * en valeur absolue > λ, met à 0 les autres.
	 *
	 * @param lambda Le seuil à appliquer.
	 * @param x      Le tableau de coefficients à seuiller.
