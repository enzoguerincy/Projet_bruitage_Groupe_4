...
public class MainController {
    ...
    public void loadView(String fxmlPath) {
        try {
            ...
            if (controller instanceof ControllerByMain controllerByMain) {
                controllerByMain.setMainController(this);
                // Appelle initView() si présent
                if (controller instanceof ResultatController resultatController) {
                    resultatController.initView();
                }
            }
